...
\caption{(a) pair of pants (b) point clouds}
\label{fig:1}
\end{figure}
...
\end{equation}
This leads to the implementation using neural networks as in Figure (\ref{fig:dependent-type}a)
