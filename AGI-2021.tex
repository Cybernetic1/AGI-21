...
\begin{figure}
	...
	\caption{(a) symmetric neural network (b) permutation invariant vs. equivariant}
	\label{fig:symmetric}
\end{figure}
...
However, this representation of predicates-within-proposition is not efficient for logic inference.  We may visualize the non-linear (due to the softmax in $Z$) deformation of the input and output vector-embedding spaces as in Figure (\ref{fig:embedding}).
