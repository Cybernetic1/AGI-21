...
Fig. \ref{fig:embedding}B is an example of such an operation.  The object ``Socrates'' is copied from one position to another.  By inspecting equation (\ref{eqn:self-attention}) we surmise that BERT is capable of such manoeuvres, with appropriately learned Keys and Values.
